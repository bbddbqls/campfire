...
public class UserBoardController {
	...
	public int likePost(@RequestParam(value = "postNum", defaultValue = "-1") int postNum, HttpSession session, Model model) {
	...
	public int unikePost(@RequestParam(value = "postNum", defaultValue = "-1") int postNum, HttpSession session, Model model) {
