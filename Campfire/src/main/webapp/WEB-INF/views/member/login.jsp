		...
		<header id="header">
			...
			<div class="content">
				<div class="inner">
					<h1>campfire</h1>
					<p>
						campfire는 늘어나는 캠퍼들에게 다양한 정보를 제공하는 웹사이트 입니다. <br /> 사람들과 소통하며 휴식과
						모험의 즐거움을 함께 나눠보세요 <br /> Enjoy nature in various ways!
					</p>
				</div>
			</div>
			<nav>
				<ul>
					<li><a href="/member/go.do">Go</a></li>
		...
		<div id="main">
			...
			<article id="contact">
				...
				<form method="post" action="member/login.do">
					<div class="fields">
						<div class="field">
							<label for="id">ID</label> <input type="text" name="memberId"
								id="id" />
						</div>
						...
						<div
							...
							<a href="#joinj"
								style="font-size: 0.6rem; margin-left: 6rem; margin-top: 0.5rem">
								<span>회원가입</span>
							</a> &nbsp; &nbsp; <a href="#"
								style="font-size: 0.6rem; margin-right: 5.5rem; margin-top: 0.5rem;">
								<span>ID·PW 찾기</span>
							</a> &nbsp; &nbsp;
						</div>
						...
						<ul class="icons">
							<li><a href="#" onmouseover="darkenImage(this)"
								onmouseout="resetImage(this)" style="cursor: pointer">
									<img src="/resources/images/google-plus-165-svgrepo-com.svg"
									alt=""
									style="border-radius: 50%; border: 1px solid white; width: 35px; height: 35px; object-fit: contain;"
									class="brighten-on-hover" />
							</a></li>
							<li><a href="#" onmouseover="darkenImage(this)"
								onmouseout="resetImage(this)" style="cursor: pointer">
									<img src="/resources/images/kakao-talk-fill-svgrepo-com.svg"
									alt=""
									style="border-radius: 50%; border: 1px solid white; width: 35px; height: 35px; object-fit: contain;"
									class="brighten-on-hover" />
							</a></li>
							...
							<li><a href="#" onmouseover="darkenImage(this)"
								onmouseout="resetImage(this)" style="cursor: pointer">
									<img src="/resources/images/btnDC.png" alt=""
									style="border-radius: 50%; border: 1px solid white; width: 35px; height: 35px; object-fit: contain;"
									class="brighten-on-hover" />
							</a></li>
			...
			<article id="joinj">
				<div>
					<a id="business" onclick="handleButtonClick1()"
						onmouseover="darkenImage(this)" onmouseout="resetImage(this)"
						style="cursor: pointer"> <img
						src="/resources/images/tie-svgrepo-com.svg" alt=""
						style="border-radius: 60%; border: 1px solid white; width: 50px; height: 50px; object-fit: contain;" />
					</a>
					<p>사업자</p>
				</div>

				<div>
					<a id="personal" onclick="handleButtonClick2()"
						onmouseover="darkenImage(this)" onmouseout="resetImage(this)"
						style="cursor: pointer"> <img
						src="/resources/images/camping-svgrepo-com.svg" alt=""
						style="border-radius: 60%; border: 1px solid white; width: 50px; height: 50px; object-fit: contain;"
						class="brighten-on-hover" />
					</a>
				...
				<div class="form-container">
					<section>
						...
						<input type="text" class="box" id="sample6_address"
							...
							style="flex-basis: 70%" /> <br />
						<div class="gender-container">
							성별: <input type="radio" id="male" name="gender" value="남성" /> <label
								for="male">남성</label> <input type="radio" id="female"
								name="gender" value="여성" /> <label for="female">여성</label>
						</div>
						<br />
						...
						<div class="info" id="info__birth">
							<div id="birth-flex">
								<select class="box" id="birth-year" style="width: 100px">
									<option>년</option>
								</select> <select class="box" id="birth-month" style="width: 100px">
									<option>월</option>
								</select> <select class="box" id="birth-day" style="width: 100px">
									<option>일</option>
								</select>
							</div>
							<div class="error-msg"></div>
			...
			<article id="personaljoin">
				...
				<div class="form-container">
					<section>
						...
						<input type="text" class="box" id="name" required
							placeholder="이름:" />
						...
						<input type="text" class="box" id="sample6_address1"
							placeholder="주소" /> <input type="text"
							id="sample6_detailAddress1" placeholder="상세주소"
							style="flex-basis: 70%" /> <br />
						<div class="gender-container">
							성별: <input type="radio" id="male1" name="gender" value="남성" /> <label
								for="male1">남성</label> <input type="radio" id="female1"
								name="gender" value="여성" /> <label for="female1">여성</label>
						</div>
						<br />
						...
						<div class="info" id="info__birth1">
							<div id="birth-flex">
								<select class="box" id="birth-year1" style="width: 100px">
									<option>년</option>
								</select> <select class="box" id="birth-month1" style="width: 100px">
									<option>월</option>
								</select> <select class="box" id="birth-day1" style="width: 100px">
									<option>일</option>
								</select>
							</div>
							<div class="error-msg"></div>
...
print 'It took ' + i + ' iterations to sort the deck.';</code>
				...
				<section>
					...
					<ul class="actions">
						<li><a href="#" class="button primary icon solid fa-download">Icon</a>
						</li>
						<li><a href="#" class="button icon solid fa-download">Icon</a>
						</li>
					</ul>
					<ul class="actions">
