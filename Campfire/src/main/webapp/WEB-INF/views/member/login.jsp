      ...
      <header id="header">
        ...
        <div class="content">
          <div class="inner">
            <h1>campfire</h1>
            <p>
              campfire는 늘어나는 캠퍼들에게 다양한 정보를 제공하는 웹사이트
              입니다. <br />
              사람들과 소통하며 휴식과 모험의 즐거움을 함께 나눠보세요 <br />
              Enjoy nature in various ways!
            </p>
          </div>
        </div>
        <nav>
      ...
      <div id="main">
        ...
        <article id="contact">
          ...
          <form method="post" action="member/login.do">
            <div class="fields">
              ...
              <div class="field">
                ...
                <input type="text" name="memberPassword" id="password" />
              </div>
          ...
          <ul class="icons">
            <li>
              <a
                href="#"
                onmouseover="darkenImage(this)"
                onmouseout="resetImage(this)"
                style="cursor: pointer"
              >
                <img
                  src="/resources/images/google-plus-165-svgrepo-com.svg"
                  alt=""
                  style="
                    border-radius: 50%;
            ...
            <li>
              ...
              >
                <img
                  src="/resources/images/kakao-talk-fill-svgrepo-com.svg"
                  alt=""
                  style="
                    border-radius: 50%;
                    border: 1px solid white;
            ...
            <li>
              ...
              >
                <img
                  src="/resources/images/btnDC.png"
                  alt=""
                  style="
                    border-radius: 50%;
                    border: 1px solid white;
        ...
        <article id="joinj">
          <div>
            ...
            >
              <img
                src="/resources/images/tie-svgrepo-com.svg"
                alt=""
                style="
                  border-radius: 60%;
                  border: 1px solid white;
          ...
          <div>
            ...
            >
              <img
                src="/resources/images/camping-svgrepo-com.svg"
                alt=""
                style="
                  border-radius: 60%;
                  border: 1px solid white;
            ...
            <section>
              ...
              <div style="display: flex; gap: 10px">
                ...
                <input
                  type="button"
                  id="search"
                  onclick="sample6_execDaumPostcode1()"
                  value="우편번호 찾기"
                />
              </div>
