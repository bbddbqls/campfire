	...
	<div id="wrapper">
		...
		<div id="main">
			<div class="inner">
				<!-- Header -->
				<header id="header">
					<a href="#" class="logo"><strong>Campfire</strong> 마이페이지</a>
				</header>
        ...
        <div class="container py-4">
            ...
            <form action="mypageup.do">
                	...
                	<div class="info" id="info__id">
						 ...
						 <input type="text"
								class="box" id="name" required 
								name="memberName" value="${member.memberName}" disabled/>
                ...
                <div style="display: flex; gap: 10px; align-items: baseline;">
					...
					<input type="text" class="box" id="sample6_postcode"
									...
									style="flex-basis: 70%" value="${member.memberPostalcode}" disabled/> 
					<input type="button" id="search"
									onclick="sample6_execDaumPostcode()" value="우편번호 찾기" disabled/>
							</div>

					<input type="text" class="box" id="sample6_address"
								placeholder="주소" name="memberAdd1" value="${member.memberAdd1}" disabled/>
					<input type="text" id="sample6_detailAddress" placeholder="상세주소"
								style="flex-basis: 70%" name="memberAdd2" value="${member.memberAdd2}" disabled/>
					  <br>
...
<br>
				...
				<div class="d-grid gap-2">
                 <button class="btn btn-primary btn-lg" type="submit">수정 하기</button>
          		 ...
          		 <button id="pwupButton">비밀번호 변경</button>
